...
**Process:**
- Find connections between people with similar interests
- "So if I like, somewhere, I can find people to like. We like..."
- Assess what the community actually needs
- Understand what people want before building

**Key Insight:** "So we need to find out what are these is. Why? Because. That's all the world is un defining."

---

### 2. Game Design & Development Cycles

**The Process:**
- "The process of designing a game involves creating a new fracture of the brass in each development cycle"
- Prioritize investment in the most important aspects
- Each cycle develops something new
- "So we need to ri all these springs and in each spread we develop a new fracture and of the brass."
...
### 4. Social App Development Case Study

**The App Concept:**
- Help people meet new friends
- Particularly for people who recently moved to a new area
- Use AI to match users based on shared interests and activities
- Free to use initially

**The Problem:**
- "So where is really related? So, basically, the two costs."
- Need to find what people actually want
- "If anything to look at some things that is we because of poism."

**Development Process:**
1. **First step** - Find connections, meet people with similar interests
...
**The Cycle:**
- **First spring** - Initial development
- **Sales** - Testing with users
- **Lewis** - Iteration and improvement
...
**Why We Design:**
- "Because are we going to defense, do they know what asking for?"
- "What I'm saying, he brought the left. What, we are. You say me know what me rain."

**Reality:** "Well, actually, the real part is that the real thing we know, and then percent of that real problem."

---

### 6. The "Build It and They Will Come" Problem

**The Mistake:**
- "That's how things, you f, oh, this is gonna be great. And then is second believe business."
- Building something without understanding if people want it
- Assuming people will pay for it

**Example from Class:**
- Student spent half a million dollars
- Was not successful
- "I struggle in the gun system with the body."
- When asked what kind of makeability, he said "this is nothing."
...
- "So if we want to create value, we need to find out these box of space."
- "And therefore, we need to find out what is happening."
...
### 8. Community Before Product

**Key Principle:** "So in this case, because of community before, the directors, but for."

**Strategy:**
- Build community first
- Then build product for that community
- "So we need to find out when show this assets, our room."
...
**Who Might Pay:**
- "Maybe someone who, like, moved to, like, a new area for school or work."
- "Or people who are looking for roommates."

**Reality Check:**
- Exercise with students - "They were so. No one this."
- "So last month pay for your. Nothing. Nothing at all."
...
**What Happened:**
- Traveled all the States trying to sell the app
- "And I tell you no one."
- "So they are school years so well. We are."
- "And so they just bring all, because they actually just This is not going to be."
...
### 11. Pivoting the Business Model

**New Strategy:**
- "So now for world, now we are like a genu. We are weed and beated and this wall."
- "And when you chance to this world, it's falling. You have a res people, you anymore."

**New Focus:**
- "So now these days, we are investing, and new business model. Focus on Paris."
- Trying to solve two things:
  1. Awarding process (board in Japan)
  2. Make friends from the murder, the first day
...
**Strategy:**
- Working with universities (Texas, etc.)
- "We are working today, no one. Texas, working with Texas on called Joe andbedd"
- "And we have a friend who whether this will be good to your adventures."
...
- User engagement
- "I think it's the number of people who would like, subscribe to the paid subscription"
...
### 15. Google's Business Model Example

**Key Question:** "How much are you paying any move for using world to search for things? You made it? No. Are you using? Yes."

**The Model:**
- Google is free for users
- Makes money through advertising
- "You see that? Even in your own. Then Google is something to find out how to make money is that actually get really."
...
- "So reviews typically either or not super good or not super."
- "So, bro, I used to lose toor reviews. I' say, I'm say at I have three stars of the lot. It with one or five."

**Key Insight:**
- "If the restaurant was bad, the God got no good."
- "If the restaurant is super super. If the original super, let's go, you."
...
### 17. Service Quality & Expectations

**Key Concept:** "So my point is that DVP service is this, why do we need is very very"

**Example:**
- "So, for instance, probably here from a service anyway. And kitchen is a service."
- "And we find a beautiful questions about their blood is kitchen, probably some beautiful Connect, sometimes it."
- "It's awful, but then doing here's better."
...
### 18. Branding & Information Strategy
...
### 19. The Lobby Industry

**Definition:** "Do you know what the lobby is? Emotional? Loing. So communication."

**What They Do:**
- "These guys are basically, people, who are either is of the of the fact, we be body."
- "So basically, these guys are friends, Sp in name from friends to are."
...
### 20. Inditex Case Study

**The Story:**
- "So my my name is two years, I'm remember, and we went to talk to Index is a comp."
- "And actually Gold why don't you work for us? Doing this going?"

**The Offer:**
- "Because in that way, we will do our great. We do we are really, we are run sexist story."
- Work for free, get endorsements

**The Response:**
- "But this was, when the family had no way both of us. Butitioning wasn't well."
- "He said that I've been there for 12 years and they' already not been success with progress that'."
...
### 21. Investment & Processing Costs
...
**The Calculation:**
- "So, we put more to br for a processing."
- "Frank, the waves guys started the fed was spok by here, zero zero."
- "He said, right. Is that I know right?"

**The Answer:**
- "So you will say, so we have that our 80,000 years."
- "So up 8,000 years, I since we are, because we need to go to all these screens?"
...
2. **Testing as investing** - Testing is part of development, not separate
3. **Build community before product** - Community comes first
4. **Don't assume people will pay** - Test willingness to pay early
5. **Iterate based on feedback** - Each cycle develops something new
6. **Focus investment** - Invest in what matters most, not everything
7. **Understand the problem** - Don't build solutions to problems that don't exist
8. **Pivot when needed** - If no one wants to pay, change the model
9. **Partnerships can help** - Work with universities, corporations
10. **Free can work** - Google model: free service, paid through advertising
11. **Branding matters** - Strong brands need less information
12. **Success metrics matter** - Define what success looks like
13. **Service quality varies** - Manage expectations
14. **Real world > theory** - Application matters more than perfect theory
...
- Traveled all States, no sales
- Lesson: Build community first, understand needs
...
**Inditex:**
- Offered free work for endorsements
- Brand wasn't strong enough
- Strategy: Build brand first, then partnerships

**Testing as Investing:**
- Book recommendation
- Testing is part of development
- Focus investment on priorities

---

## Next Steps

- Continue with product development strategies
- Explore more business models
- Understand community building
- Tomorrow: Continue discussion
...
- Focus investment on what matters
- Real world application > perfect theory
