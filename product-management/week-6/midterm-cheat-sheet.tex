...
\begin{document}
\begin{center}
{\normalsize\bfseries Product Management -- Midterm Cheat Sheet}\\[0.2em]
\footnotesize\textit{Use for quick recall; in exam: define terms, give one example, tie to value creation/capture.}\\[0.4em]
...
\section*{Unit 0 -- Course \& Big Ideas}\handnote{Creation $\neq$ capture.}
...
\section*{Unit 1 -- Value Creation vs.\ Capture}\handnote{Need both. Teece.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 2 -- Community \& Needs Assessment}\handnote{Before you build.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 3 -- Cost \& Production}\handnote{Cost $\neq$ price.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 4 -- BMC \& Product Design}\handnote{Validate before you build.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 5 -- Exploration vs.\ Exploitation}\handnote{Ambidextrous org.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 6 -- Design Thinking}\handnote{Observe, don't ask.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 7 -- Innovation \& Technology}\handnote{S-curve. Disrupt.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 8 -- User Interviews \& Product Design}\handnote{Zoom or in-person.}
User interviews: real users, behavioral questions (``last time...''). Value engineering: cut cost/simplify (spoon, plastic vs ceramic). Platform design: one base, many variants (BMW). Mass customization. Less is more.
...
\item User interviews, value engineering, platform design, mass customization.
...
\item \textbf{``Value engineering?''} Change design to cut cost or simplify. \textbf{``Platform design?''} One base, many variants (BMW).
\end{itemize}
...
\textbf{Unit 1 -- Value}\\
Creation vs.\ capture. Market access. Takeda. Porter. Teece. Co-specialized assets.
...
9 blocks. Validate before build. Lean. Customer discovery. Gartner.

\textbf{Unit 5 -- Exploration/Exploitation}\\
Sensing vs.\ seizing. Ambidextrous. SDLC.

\textbf{Unit 6 -- Design Thinking}\\
Observe don't ask. Gemba. Extreme users. Two observers. 5 stages.

\textbf{Unit 7 -- Innovation}\\
S-curve. Disruptive. Kodak. Innovator's dilemma. First mover. Peloton, Tesla.

\textbf{Unit 8 -- Interviews \& Design}\\
User interviews. Value engineering. Platform design. Mass customization.
