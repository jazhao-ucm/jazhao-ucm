...
### IV. Brand Strategy & Information Asymmetry

A. Strong Brands
1. Less need to share detailed information
2. Rely on emotion over providing detailed product information
3. Create emotional connections instead of information-based decisions

B. Weak Brands
1. Must provide information themselves
...
### V. Case Study: Chanel & Luxury Brands

A. Why Doesn't Chanel Sell on Amazon?

B. Reasons
1. Tacky - Would bring down the brand
2. Liability - Amazon relation shipping, things that they are as a high value
...
### VI. Market Signaling & Asymmetric Information

A. The "Lemons Market" Problem
1. Products that look good but have hidden problems
2. Example: Used cars that look shiny outside but have issues inside

B. Modern Example
1. AI-generated product ads that don't match reality
2. People post AI-generated products (mugs, blankets)
...
### VII. University Selection Example

A. Decision Making Process
1. Choosing between universities (IU, University of Miami, etc.)
2. "Could you make a rational decision for praying all these universities in the States?"
3. Depends on what you want to study

B. Factors
1. Alumni network
2. Age/reputation of school
3. Technology vs. traditional
4. Location
5. Cost
...
### IX. Case Study: Solar Panel Technology Competition

A. The Scenario
1. Firm A is developing solar panel technology
2. Firm B already has patents on similar technology
3. How does Firm A prevent Firm B from blocking them?

B. Solutions
1. Pay Firm B to use their technology
2. Develop your own technology - Spend more on R&D
...
### X. Patent Portfolio Management

A. Key Strategy
1. Check what patents competitors have
2. Check what patents exist in your area
...
### XII. Case Study: IBM & Open Source

A. The Strategy
1. IBM made their development platform open source
2. Gave it away for free
3. "So they transformed that in a rain program into our source. So anyone who play another space on plat band."

B. Why Give Away Valuable Technology?
1. Created industry standard
...
### XIII. David Teece & Open Innovation Theory

A. About David Teece
1. Developed theory of open innovation
...
### XIV. Samsung Strategy

A. Business Model
1. Three main businesses:
2. Consumer electronics - Phones, TVs, etc.
3. Semiconductors - Chips and components
4. Licensing - Licensing their technology
...
2. "So these guys are and creating technology, really really bad at making money from."

C. What Happened
1. Eventually had to sell technologies for very little money
2. "Basically, the soul that continies for a few dollars."
3. "They discovered that this beautiful and every day. But just."
...
4. Co-specialized assets - Assets specialized to your business
5. Specific assets - Unique assets for your business

B. Value Capture Mechanisms
1. Brand - Brand reputation
...
1. Decisions combine rationality AND emotion - Not purely rational
2. Less information → More emotional decisions
3. More information → More rational decisions
4. Strong brands rely on emotion, not detailed information
5. Weak brands must provide information themselves
6. Patents serve two purposes - Protect your tech AND prevent competitors from blocking you
7. Patent portfolios are strategic tools for negotiation
8. Open innovation can create industry standards and generate demand
9. IBM example - Gave away software, made money on hardware
10. Xerox PARC - Great at innovation, terrible at commercialization
11. Samsung - 40% revenue from licensing, 60% from products
12. Information asymmetry affects decision making
13. Market signaling helps when buyers have limited information
14. Brand strategy depends on brand strength

---

## Important Examples from Class

A. Chanel & Luxury Brands
1. Don't sell on Amazon
2. Rely on emotion and exclusivity
3. Don't need to provide detailed information
4. Justify high prices through scarcity

B. IBM Open Source
1. Gave away development platform
2. Created industry standard
3. Made money from hardware/servers
4. Example of open innovation strategy

C. Xerox PARC
1. Developed mouse, GUI, Ethernet, laser printing
2. Terrible at making money from innovations
3. Sold technologies for very little
4. Lesson: Innovation ≠ Commercialization

D. Solar Panel Patents
1. Firm A vs. Firm B patent competition
2. Strategies: Pay, develop, acquire, or build portfolio
3. Shows importance of patent strategy

E. University Selection
1. Choosing between universities
2. Information challenges (SEO, sponsored results)
3. Rational vs. emotional factors

---

## Next Steps

1. Continue with value creation and capture
2. Explore more innovation strategies
3. Understand commercialization better
4. Next Monday: Continue discussion

---

## Final Thought

A. "Innovation alone isn't enough - you need commercialization strategy."

B. Remember
1. Strong brands = emotion over information
2. Weak brands = must provide information
3. Patents = protect AND prevent blocking
