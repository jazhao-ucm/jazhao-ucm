...
### II. Game Design & Development Cycles

A. The Process
1. "The process of designing a game involves creating a new fracture of the brass in each development cycle"
2. Prioritize investment in the most important aspects
...
### IV. Social App Development Case Study

A. The App Concept
1. Help people meet new friends
2. Particularly for people who recently moved to a new area
3. Use AI to match users based on shared interests and activities
4. Free to use initially

B. The Problem
1. "So where is really related? So, basically, the two costs."
2. Need to find what people actually want
3. "If anything to look at some things that is we because of poism."
...
### VI. The "Build It and They Will Come" Problem
...
A. What Happened
1. Traveled all the States trying to sell the app
...
### XI. Pivoting the Business Model
...
### XII. Partnerships & Sponsorships

A. Strategy
1. Working with universities (Texas, etc.)
...
4. Lesson: Build community first, understand needs
...
D. Testing as Investing
1. Book recommendation
2. Testing is part of development
3. Focus investment on priorities
...
3. Understand community building
