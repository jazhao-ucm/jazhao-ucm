% Spanish – Midterm Cheat Sheet (Units 1–3)
...
\begin{document}
\begin{center}
{\normalsize\bfseries Spanish -- Midterm Cheat Sheet (Units 1--3)}\\[0.2em]
\footnotesize\textit{Use for quick recall; mock exams: datos personales, por/para, nacionalidades, pronunciaci\'on.}\\[0.4em]
...
\section*{Unit 1 -- Preguntas de identificaci\'on}\handnote{Match question to answer.}
...
\section*{Ser, tener, llamarse}\handnote{Conjugations for descriptions.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{N\'umeros (0--50)}\handnote{Escribe con letras.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Nacionalidades \& profesiones}\handnote{Agreement: -o (m), -a (f).}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Lenguas por pa\'is}\handnote{Gentilicio = lengua.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Actividades para aprender}\handnote{Ver, escuchar, leer, escribir, practicar, hacer.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Por vs.\ Para}\handnote{Por = reason. Para = purpose.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{C o qu?}\handnote{Before e, i: use qu.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Pronunciaci\'on -- Carlos, Garc\'ia, Javier, Celia}\handnote{Sound reference words.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Listening -- Datos personales}\handnote{5 correct: name, origin, nationality, age, profession.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Listening -- Una fiesta}\handnote{True/False. Listen carefully.}
\begin{itemize}[leftmargin=*,nosep]
\item Ana: not from Argentina; not cocinera. Elvira: colombiana. Stephanie: not Dutch. Jos\'e Antonio: profesor de espa\~nol.
\end{itemize}

\section*{Presente -- verbos regulares}\handnote{-ar, -er, -ir.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Vocabulario \'util}\handnote{Palabras clave para ejercicios.}
\begin{itemize}[leftmargin=*,nosep]
