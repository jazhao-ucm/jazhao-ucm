# Profile summary (from archived PDF)
...
Third-year Informatics student at Indiana University Luddy. Builds scalable, data-intensive systems using quantitative reasoning, software engineering, and machine learning. In Madrid, study-abroad research on how technical practice adapts across institutional cultures (startups to enterprises). First-generation college student, Asian American, woman in STEM: designs for inclusion and mentors emerging builders. Outside research: matcha, books, strategic planning. Framing: innovation is local, global, and continuous.

---

## Contact (PDF; verify before use)

| Field | PDF value |
|-------|-----------|
| Address | 300 N Jordan Ave, Bloomington, IN 47405 |
| Phone | (312) 583-7703 (labeled Work) |
...
## Top skills (PDF labels)

Leadership, peer mentoring, user experience design (UED).

---

## Languages (PDF)

English (native or bilingual), Spanish (elementary), Fuzhounese (professional working).

---

## Honors and awards (PDF)

- Luddy Hudson and Holland Direct Admit (full-ride merit scholarship)
- Luddy Study Abroad and HIEP Grant (international scholarship)
...
- Analytics; reach and engagement improvements cited.
- Community management and campaigns with clients and influencers.

---

## Education (PDF)

- **Indiana University Bloomington:** B.S. Informatics, 2023 to 2027.
- **Cathedral High School:** Diploma, 2019 to 2023.
