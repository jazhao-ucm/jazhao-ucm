...
\begin{document}
\begin{center}
{\normalsize\bfseries Management in Global Markets -- Midterm Cheat Sheet}\\[0.2em]
\footnotesize\textit{Use for quick recall; in exam: define terms, give one example, tie to internationalization.}\\[0.4em]
...
\section*{Unit 0 -- Course \& Big Ideas}\handnote{Location = masterpiece.}
...
\section*{Unit 1 -- Globalization vs.\ Slowbalization}\handnote{Winners vs.\ losers.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 2 -- Supply Chain \& Products}\handnote{Quality vs.\ cost.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 3 -- Hofstede's Dimensions}\handnote{Culture = cannot escape.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 4 -- Four Phases \& Location}\handnote{Phase 3 = most dangerous.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 5 -- Strategy Levels \& Int'l Logic}\handnote{Corporate, competitive, functional.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 6 -- Chile Case}\handnote{Tech transfer risk.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 7 -- Export vs.\ Int'l \& FDI}\handnote{Product vs.\ company.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 8 -- International HRM}\handnote{People matter.}
\begin{itemize}[leftmargin=*,nosep]
...
\section*{Unit 9 -- Cash Generation}\handnote{Cash from customers.}
\begin{itemize}[leftmargin=*,nosep]
