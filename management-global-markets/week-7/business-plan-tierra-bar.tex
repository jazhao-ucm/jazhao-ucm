...
\textbf{4P's:}
\begin{itemize}[leftmargin=*,nosep]
\item Product: Mexican bar, burritos/tacos/nachos, craft beer, margaritas, student discount, Student Pass, events
\item Price: \`a la carte; 15\% student discount; Student Pass 20 euros/month
\item Place: Madrid Centro, Glovo, Just Eat, walk-in
\item Promotion: Instagram, TikTok, Yelp, Google, university flyers, word-of-mouth
\end{itemize}
...
\vspace{1.5em}
\noindent\fbox{\parbox{0.95\textwidth}{\small\textcolor{charcoal}{\textbf{Sources:} Class notes weeks 1--7, Global Management Project.pdf, Business plan reunidas. No external sources.}}}
