...
\section*{\color{accent}Tu introducci\'on habitual (para testimony)}
\textbf{Soy de los Estados Unidos y yo puedo hablar ingl\'es, pero en la casa hablo un dialecto de China. Y estudi\'e espa\~nol por cinco a\~nos.}\\
\footnotesize (Correcciones: ``per'' $\to$ pero; Estados Unidos, China con may\'uscula; ingl\'es con tilde; estudi\'e = pasado.)

\section*{\color{accent}Testimony (relaci\'on con idiomas) -- preguntas t\'ipicas}
\textbf{Regla:} \textbf{y} $\to$ \textbf{e} cuando la siguiente palabra empieza con \textbf{i} o \textbf{hi} (ej.\ ``chino \textbf{e} ingl\'es'', no ``chino y ingl\'es'').

1. \textquestiondown C\'omo te llamas y de d\'onde eres? Me llamo Jade, soy de Estados Unidos. 2. \textquestiondown D\'onde vives y d\'onde estudias espa\~nol? Vivo en Madrid, estudio espa\~nol en la Universidad Complutense. 3. \textquestiondown Qu\'e lenguas hablas? Hablo chino \textbf{e} ingl\'es; tambi\'en estudio espa\~nol. 4. \textquestiondown Por qu\'e estudias espa\~nol? Para hablar mejor y hacer amigos. 5. \textquestiondown Qu\'e cosas haces para aprender espa\~nol? Leo libros y hablo con mis amigos. 6. \textquestiondown Qu\'e quieres hacer para mejorar? Hablar con gente que habla espa\~nol bien y viajar. 7. \textquestiondown Planes (para) el futuro? Quiero ser cient\'ifica (de computadoras) y trabajar en otros pa\'ises. 8. (Si preguntan m\'as.) Mi primer idioma es el chino (dialecto); ingl\'es en el colegio; espa\~nol lo estudio aqu\'i.
...
\section*{\color{accent}N\'umeros y pronunciaci\'on (from chat)}
\textbf{15 = quince}, \textbf{16 = diecis\'eis} (no confundir).\\
\textbf{Spanish J} = English H sound: \textbf{Jorge} $\approx$ ``Horhey'', \textbf{Jos\'e} $\approx$ ``Hos\'e''.\\
Testimony/exam: mostly \textbf{present tense}; that's enough.
