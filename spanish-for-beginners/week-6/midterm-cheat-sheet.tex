% Spanish – Midterm Cheat Sheet (Units 1–3) — EU business casual
...
\fancypagestyle{plain}{\fancyhf{}\fancyfoot[R]{\raisebox{0.8em}{\small\color{notegrey}\thepage}}}
\raggedright

\begin{document}
\begin{center}
\vspace{0.2em}
{\normalsize\bfseries\color{eublue} Spanish -- Midterm Cheat Sheet (Units 1--3)}\\[0.2em]
