...
\begin{document}
\begin{center}
{\large\bfseries Strategic Management -- Midterm Cheat Sheet}\\[0.3em]
\small\textit{Use for quick recall; in exam: define terms, give one example, tie to competitive advantage.}\\[0.6em]
...
\subsection*{\hlpink{Tangible vs intangible}}
\begin{center}
\small
\begin{tabular}{@{}lll@{}}
\toprule
...
Internal view! 70-80\% = you, not industry.
