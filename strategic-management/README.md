...
- `week-1/` - Jan 28 & 29: class notes, course intro, Unit 0 & 1 Strategy slides, SM-Illustration Unit 1 (Art of War), syllabus template
- `week-2/` - Feb 4 & 5: class notes, Unit 2 Objectives and Values slides, SM-Illustration Unit 2 (CSR, Shareholder Value)
