...
- `week-10/` - Apr 8 and 9: Apr 8 corporate growth and diversification (related vs unrelated), BCG portfolio logic, vertical integration, restructuring decisions; `2026-04-08-class-notes.md`; Apr 9 concentration, public administration intervention logic, domestic champions vs open competition, and case-method resource analysis; `2026-04-09-class-notes.md`
