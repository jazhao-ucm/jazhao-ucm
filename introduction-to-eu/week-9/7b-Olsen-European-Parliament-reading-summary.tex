...
% Compile: pdflatex 7b-Olsen-European-Parliament-reading-summary.tex
%
% Fill-in rules:
...
\title{Author Name: \textit{Olsen European Parliament}\\Key Themes \& Arguments --- Housing-crisis workshop lens}
...
\item \textbf{Title:} Olsen European Parliament (as shown on PDF)
\item \textbf{Source:} 7b Olsen European Parliament.pdf
