...
% Compile: pdflatex 7a-Parlamentary-Europe-reading-summary.tex
%
% Fill-in rules:
...
\title{Author Name: \textit{Parliamentary Europe}\\Key Themes \& Arguments --- Housing-crisis workshop lens}
...
\item \textbf{Title:} Parliamentary Europe (as shown on PDF)
\item \textbf{Source:} 7a Parlamentary Europe.pdf
...
\item How does the text describe parliamentary procedure/roles (e.g., how proposals "pass" or are blocked), and how would that shape a housing-crisis debate?
